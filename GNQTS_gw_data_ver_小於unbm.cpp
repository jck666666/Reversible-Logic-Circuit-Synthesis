...
int Form[] = {6, 6, 6, 10, 17, 10, 6, 8, 10, 10, 10, 10, 12, 15, 13, 16, 13, 10};
int Forn[] = {3, 3, 3, 3, 4, 3, 4, 4, 3, 3, 3, 3, 4, 4, 4, 4, 4, 3};
...
int function[mMAX][mMAX] = {
    ...
    {0, 1, 2, 3, 4, 6, 5, 7},
    {0, 1, 2, 4, 3, 5, 6, 7},
    {0, 1, 14, 15, 4, 5, 10, 11, 7, 9, 6, 8, 12, 13, 2, 3},
    {1, 2, 3, 4, 5, 6, 7, 0},
    ...
    {4, 3, 0, 2, 7, 5, 6, 1},
    {7, 5, 4, 2, 0, 1, 6, 3},
    {6, 3, 14, 13, 2, 11, 7, 10, 0, 5, 8, 1, 12, 15, 9, 4},
    {0, 9, 10, 5, 4, 15, 14, 8, 11, 2, 6, 3, 12, 7, 1, 13},
